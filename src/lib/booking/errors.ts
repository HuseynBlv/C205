/**
 * The seven stable identifiers supabase/migrations/20260906100000_booking_engine.sql
 * and supabase/migrations/20260910150000_extended_meeting_buffer_and_48h_notice.sql
 * return as the exception message itself. Anything else (bad input shape,
...
/** The raw code if `message` is one of the seven stable identifiers,
